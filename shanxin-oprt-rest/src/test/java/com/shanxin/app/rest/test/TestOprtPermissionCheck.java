...
public class TestOprtPermissionCheck {
	...
	public void doTest() {
		try {
			...
			OprtPermissionCheckRequest request = new OprtPermissionCheckRequest();
			request.setMethod(request.getLocalMothedName());
			request.setTimestamp(new Date());
			request.setOprtId(1);
			request.setOprtSecret("e99a18c428cb38d5f260853678922e03");
			request.setOprtAccessToken("2e4eeca46d1d1fd3ae773f05374b3c1f8797659df2a5e17acd68b91255e3f887");
			request.setCheckMethod("com.shanxin.test.get");
